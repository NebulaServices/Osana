...
window.addEventListener = new MessageProxy.default(window) as any;
window.Worker.prototype.addEventListener = new MessageProxy.default(window.Worker.prototype) as any;